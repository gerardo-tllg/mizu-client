...
<p align="center">
<img src="assets/meteor-client/icon.png" alt="mizu-client-logo" width="15%"/>
</p>
...
### Installation
Run `./gradlew build` and install the jar from `build/libs/`.
...
*If you have any other questions, reach out to the Mizu team.*
