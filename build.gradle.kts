...
dependencies {
    ...
    // XaeroPlus and Xaero's maps (for hunting modules BetterStashFinder, TrailFollower, ElytraFlyPlusPlus)
    modCompileOnly("maven.modrinth:xaeroplus:${properties["xaeroplus_version"] as String}") { isTransitive = false }
    modCompileOnly("maven.modrinth:xaeros-minimap:${properties["xaeros_minimap_version"] as String}") { isTransitive = false }
    modCompileOnly("maven.modrinth:xaeros-world-map:${properties["xaeros_worldmap_version"] as String}") { isTransitive = false }
    
    // Additional dependencies for hunting modules
    modCompileOnly("net.lenni0451:LambdaEvents:2.4.2") { isTransitive = false }
    modCompileOnly("com.github.ben-manes.caffeine:caffeine:3.1.8") { isTransitive = false }
