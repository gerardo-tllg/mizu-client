...
public class HudRenderer {
    ...
    public void end() {
        // Renderer2D.render() signature changed in 1.21.5 - render without parameters
        ...
        if (hud.hasCustomFont()) {
            ...
            for (Iterator<FontHolder> it = fontsInUse.values().iterator(); it.hasNext(); ) {
                ...
                if (fontHolder.visited) {
                    // In 1.21.5, use MeshRenderer with the UI_TEXT pipeline
                    // Bind texture manually before rendering since Meteor's Texture doesn't fully support GpuTexture yet
    ...
    public void texture(Identifier id, double x, double y, double width, double height, Color color) {
        ...
        // Renderer2D.TEXTURE.render() changed in 1.21.5 - render without parameters
    ...
    public double text(String text, double x, double y, Color color, boolean shadow, double scale) {
        ...
        // In 1.21.5, use MeshBuilder instead of Mesh
    ...
    private static class FontHolder {
        ...
        public MeshBuilder getMesh() {
            // In 1.21.5, use MeshBuilder with UI_TEXT pipeline
        ...
        public void destroy() {
            // In 1.21.5, dispose texture instead of clearGlId
