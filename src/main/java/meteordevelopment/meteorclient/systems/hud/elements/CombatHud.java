...
public class CombatHud extends HudElement {
    ...
    public void render(HudRenderer renderer) {
        renderer.post(() -> {
            ...
            InventoryScreen.drawEntity(
                ...
                -MathHelper.wrapDegrees(playerEntity.getYaw()),
    ...
    private ItemStack getItem(int i) {
        ...
        return switch (i) {
            ...
            // armor made accessible via access widener in 1.21.5
            default -> ((meteordevelopment.meteorclient.mixininterface.IPlayerInventory) playerEntity.getInventory()).meteor$getArmor().get(i);
        };
    }
}
