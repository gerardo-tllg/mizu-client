...
public class PlayerModelHud extends HudElement {
    ...
    public void render(HudRenderer renderer) {
        renderer.post(() -> {
            ...
            // prevYaw removed in 1.21.5 - using getYaw() directly
            float yaw = copyYaw.get() ? MathHelper.wrapDegrees(player.getYaw() + offset) : (float) customYaw.get();
    ...
    private void drawEntity(DrawContext context, int x, int y, int size, float yaw, float pitch, LivingEntity entity) {
        ...
        // prevHeadYaw removed in 1.21.5 - using headYaw directly
        float previousPrevHeadYaw = entity.getHeadYaw();
        ...
        // prevHeadYaw removed in 1.21.5 - setting headYaw directly
        ...
        // Restore headYaw
        entity.setHeadYaw(previousPrevHeadYaw);
