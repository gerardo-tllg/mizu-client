...
// import meteordevelopment.meteorclient.systems.managers.Managers;
...
public class PlayerRadarHud extends HudElement {
    ...
    public void tick(HudRenderer renderer) {
        ...
        for (PlayerEntity entity : getPlayers()) {
            ...
            // MeteorClient.INFO removed - totemPops feature disabled for now
            // if (totemPops.get() && Managers.get(InformationManager.class).getPops(entity) > 0) text += "" + -Managers.get(InformationManager.class).getPops(entity);
    ...
    public void render(HudRenderer renderer) {
        ...
        for (PlayerEntity entity : getPlayers()) {
            ...
            // if (totemPops.get() && Managers.get(InformationManager.class).getPops(entity) > 0) width += spaceWidth;
            ...
            /*if (totemPops.get() && Managers.get(InformationManager.class).getPops(entity) > 0) {
                totemPopsText = "" + -Managers.get(InformationManager.class).getPops(entity);
