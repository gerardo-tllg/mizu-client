...
public class HoleHud extends HudElement {
    ...
    private Direction get(Facing dir) {
        ...
        // Direction.fromRotation renamed to fromHorizontalDegrees in 1.21.5
        float yaw = MathHelper.wrapDegrees(mc.player.getYaw() + dir.offset);
        return Direction.fromHorizontalDegrees(yaw).getOpposite();
    }
