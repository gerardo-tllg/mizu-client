...
import static meteordevelopment.meteorclient.systems.modules.hunting.HuntingUtils.*;
...
//            onActivate();
    ...
    private void sendSwapPacket(Int2ObjectMap<ItemStack> changedSlots, int buttonNum) {
        // TODO: ClickSlotC2SPacket signature changed in 1.21.5
        // Fake fly feature temporarily disabled until packet API is updated
        warning("Fake fly feature is currently disabled in 1.21.5");
    }
