...
import meteordevelopment.meteorclient.systems.modules.hunting.HuntingUtils;
...
import static meteordevelopment.meteorclient.systems.modules.hunting.HuntingUtils.positionInDirection;
import static meteordevelopment.meteorclient.systems.modules.hunting.HuntingUtils.sendWebhook;
            ...
            if (mc.player != null && mc.world != null)
            {
                ...
                if (followMode == FollowMode.YAWLOCK && !mc.world.getRegistryKey().equals(World.NETHER)) {
                    if (overworldFlightMode.get() == OverworldFlightMode.PITCH40) {
                        // Use Meteor's ElytraFly with Pitch40 mode instead of removed Pitch40Util
                        info("Enable Movement ? ElytraFly (Mode: Pitch40) for pitch 40 flight.");
        ...
        switch (followMode)
        {
            ...
            case YAWLOCK: {
                ...
                if (overworldFlightMode.get() == OverworldFlightMode.VANILLA) {
                    ...
                    if (pitch40Util != null && pitch40Util.isActive()) {
                        pitch40Util.toggle();
                    }
                }
                break;
...
//                    }
            ...
            case YAWLOCK: {
                mc.player.setYaw(HuntingUtils.smoothRotation(getActualYaw(mc.player.getYaw()), targetYaw, rotateScaling.get()));
                break;
            }
        }
...
//                log("ChunkPos: " + chunkPos.x + ", " + chunkPos.z);
        ...
        double angleDiff = HuntingUtils.angleDifference(targetYaw, chunkAngle);
