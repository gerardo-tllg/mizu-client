...
public class Packet extends ElytraFlightMode {
    ...
    public void onTick() {
        ...
        if (((meteordevelopment.meteorclient.mixininterface.IPlayerInventory) mc.player.getInventory()).meteor$getArmor().get(2).getItem() != Items.ELYTRA || mc.player.fallDistance <= 0.2 || mc.options.sneakKey.isPressed()) return;
