...
public class AutoWasp extends Module {
    ...
    private void onTick(TickEvent.Pre event) {
        ...
        // In 1.21.5, check for elytra by item ID instead of instanceof
        if (mc.player.getEquippedStack(EquipmentSlot.CHEST).getItem() != net.minecraft.item.Items.ELYTRA) return;
