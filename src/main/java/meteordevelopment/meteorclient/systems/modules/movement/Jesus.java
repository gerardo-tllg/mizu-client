...
public class Jesus extends Module {
    ...
    private void onSendPacket(PacketEvent.Send event) {
        ...
        // In 1.21.5, movementForward/Sideways moved to player fields
    ...
    private boolean waterShouldBeSolid() {
        ...
        if (mc.player.getVehicle() != null) {
            ...
            // In 1.21.5, boat types renamed
            if (vehicle == EntityType.OAK_BOAT || vehicle == EntityType.OAK_CHEST_BOAT) return false;
        }
    ...
    private boolean lavaIsSafe() {
        ...
        // In 1.21.5, getAttributeValue and attribute names changed
