...
public class Modules extends System<Modules> {
    ...
    private void initHunting() {
        add(new meteordevelopment.meteorclient.systems.modules.hunting.AFKVanillaFly());
        add(new meteordevelopment.meteorclient.systems.modules.hunting.AutoEXPPlus());
        add(new meteordevelopment.meteorclient.systems.modules.hunting.AutoLogPlus());
        add(new meteordevelopment.meteorclient.systems.modules.hunting.AutoPortal());

        // Baritone-dependent modules - only load if Baritone is present
        if (net.fabricmc.loader.api.FabricLoader.getInstance().isModLoaded("baritone")) {
            try {
                add(new meteordevelopment.meteorclient.systems.modules.hunting.AutoRegear());
                add(new meteordevelopment.meteorclient.systems.modules.hunting.BaritoneElytraGoto());
                add(new meteordevelopment.meteorclient.systems.modules.hunting.ElytraFlyPlusPlus());
                add(new meteordevelopment.meteorclient.systems.modules.hunting.TrailFollower());
            } catch (Throwable e) {
                MeteorClient.LOG.error("Failed to load Baritone-dependent hunting modules", e);
            }
        }

        // Xaero's Minimap dependent modules - only load if Xaero's Minimap is present
