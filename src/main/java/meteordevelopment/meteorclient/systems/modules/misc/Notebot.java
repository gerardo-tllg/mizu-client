...
public class Notebot extends Module {
    ...
    private void tuneNoteblockWithPackets(BlockPos pos) {
        ...
        mc.player.networkHandler.sendPacket(new PlayerInteractBlockC2SPacket(Hand.MAIN_HAND, new BlockHitResult(Vec3d.ofCenter(pos), Direction.DOWN, pos, false), sequence));
