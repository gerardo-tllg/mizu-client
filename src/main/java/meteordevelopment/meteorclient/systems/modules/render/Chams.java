...
public class Chams extends Module {
    ...
    public void updateShader(Shader value) {
        // In 1.21.5, the render pipeline is set during ChamsShader initialization
        // and cannot be changed dynamically. The shader is always POST_IMAGE.
        // The actual rendering behavior is controlled by the shouldDraw() method.
    }
