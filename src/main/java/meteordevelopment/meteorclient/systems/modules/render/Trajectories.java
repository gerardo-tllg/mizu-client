    ...
    private class Path {
        ...
        public void render(Render3DEvent event) {
            ...
            if (collidingEntity != null) {
                double x = (collidingEntity.getX() - collidingEntity.lastRenderX) * event.tickDelta;
                double y = (collidingEntity.getY() - collidingEntity.lastRenderY) * event.tickDelta;
                double z = (collidingEntity.getZ() - collidingEntity.lastRenderZ) * event.tickDelta;
