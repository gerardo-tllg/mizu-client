...
public class PopChams extends Module {
    ...
    private class GhostPlayer {
        ...
        // private List<WireframeEntityRenderer.RenderablePart> parts; // Disabled
        private Vec3d pos;
        ...
        public boolean render(Render3DEvent event) {
            // WireframeEntityRenderer disabled - parts rendering removed
            /*if (parts == null) {
            ...
            // Y Modifier - using meteor$setY from IVec3d interface
            ((IVec3d) pos).meteor$setY(pos.y + yModifier.get() * event.frameTime);
            ...
            // Render
            // WireframeEntityRenderer.render(event, pos, parts, scale, sideColor.get(), lineColor.get(), shapeMode.get()); // Disabled
