...
// import meteordevelopment.meteorclient.utils.render.WireframeEntityRenderer; // Disabled - needs rewrite for 1.21.5
...
public class ESP extends Module {
    ...
    // Compatibility method for mixins
    ...
    public Color getEntityTypeLineColor(Entity entity) {
        if (entity instanceof PlayerEntity player) {
            ...
            // isEnemy method removed in 1.21.5
