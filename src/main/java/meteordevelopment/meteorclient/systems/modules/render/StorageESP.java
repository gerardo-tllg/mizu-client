...
public class StorageESP extends Module {
    ...
    public StorageESP() {
        ...
        // Mesh.Attrib removed in 1.21.5 - using ShaderMesh directly
        mesh = new ShaderMesh(Shaders.POS_COLOR, DrawMode.Triangles, meteordevelopment.meteorclient.renderer.Mesh.Attrib.Vec3, meteordevelopment.meteorclient.renderer.Mesh.Attrib.Color);
