...
public class NoRender extends Module {
    ...
    private final Setting<Boolean> noHurtCam = sgOverlay.add(new BoolSetting.Builder()
        .name("hurt-cam")
        .description("Disables camera shake when taking damage.")
        .defaultValue(false)
        .build()
    );
    ...
    // Compatibility method for mixins - world border rendering
    public boolean noWorldBorder() {
        return false; // No specific world border setting in this version
    }
