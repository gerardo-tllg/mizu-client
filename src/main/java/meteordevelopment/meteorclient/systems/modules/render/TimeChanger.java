...
public class TimeChanger extends Module {
    ...
    public void onDeactivate() {
        // setTimeOfDay() method removed in 1.21.5
    ...
    private void onPacketReceive(PacketEvent.Receive event) {
        if (event.packet instanceof WorldTimeUpdateS2CPacket packet) {
            // Packet API changed in 1.21.5 - commenting out
            // oldTime = packet.getTimeOfDay();
            event.cancel();
        }
    }
    ...
    private void onTick(TickEvent.Post event) {
        // setTimeOfDay() method removed in 1.21.5
        // Time rendering now handled differently - commenting out
