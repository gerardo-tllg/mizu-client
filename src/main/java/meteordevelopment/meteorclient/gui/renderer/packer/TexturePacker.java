...
public class TexturePacker {
    ...
    public Texture pack() {
        ...
        // In 1.21.5, use Texture.Format and Texture.Filter enums
        Texture texture = new Texture();
        texture.upload(width, height, buffer, Texture.Format.RGBA, Texture.Filter.Linear, Texture.Filter.Linear, false);
