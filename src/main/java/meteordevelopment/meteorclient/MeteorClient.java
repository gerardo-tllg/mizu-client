...
public class MeteorClient implements ClientModInitializer {
    ...
    public static meteordevelopment.meteorclient.systems.managers.SwapManager SWAP;
    public static meteordevelopment.meteorclient.systems.managers.BlockPlacementManager BLOCK;

    static {
        // Register lambda factory for meteorclient package BEFORE creating managers
        try {
    ...
    public void onInitializeClient() {
        ...
        // Initialize managers AFTER Systems.init() so AntiCheatConfig is available
        ROTATION = new meteordevelopment.meteorclient.systems.managers.RotationManager();
        INFO = new meteordevelopment.meteorclient.systems.managers.InformationManager();
        SWAP = new meteordevelopment.meteorclient.systems.managers.SwapManager();
        BLOCK = new meteordevelopment.meteorclient.systems.managers.BlockPlacementManager();
