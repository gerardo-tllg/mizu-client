...
public class Font {
    ...
    public Font(ByteBuffer buffer, int height) {
        ...
        texture = new Texture();
        texture.upload(size, size, bitmap, Texture.Format.A, Texture.Filter.Linear, Texture.Filter.Linear, false);
    ...
    // Reverted to accept Mesh - HudRenderer uses Mesh/ShaderMesh, not MeshBuilder
    ...
    // Overload for MeshBuilder - CustomTextRenderer uses MeshBuilder
