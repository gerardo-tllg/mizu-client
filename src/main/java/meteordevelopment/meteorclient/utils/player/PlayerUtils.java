...
public class PlayerUtils {
    ...
    public static Vec3d getHorizontalVelocity(double bps) {
        ...
        boolean a = false;
        // In 1.21.5, Input uses PlayerInput record with methods instead of fields
        ...
        // IVec3d methods have meteor$ prefix in 1.21.5
    ...
    public static boolean canSeeEntity(Entity entity) {
        ...
        ((IVec3d) vec1).meteor$set(mc.player.getX(), mc.player.getY() + mc.player.getStandingEyeHeight(),
            mc.player.getZ());
