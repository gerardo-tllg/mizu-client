...
/* JADX INFO: loaded from: meteor-client-1.21.5-local.jar:meteordevelopment/meteorclient/systems/modules/combat/AutoEXP.class */
public class AutoEXP extends Module {
    ...
    /* JADX INFO: loaded from: meteor-client-1.21.5-local.jar:meteordevelopment/meteorclient/systems/modules/combat/AutoEXP$Mode.class */
    public enum Mode {
        Armor,
        Hands,
        Both
    ...
    private void onTick(TickEvent.Pre event) {
        if (this.repairingI == -1) {
            if (this.mode.get() != Mode.Hands) {
                int i = 0;
                while (true) {
                    if (i >= this.mc.field_1724.method_31548().meteor$getArmor().size()) {
                        break;
                    }
                    if (!needsRepair((class_1799) this.mc.field_1724.method_31548().meteor$getArmor().get(i), this.minThreshold.get().intValue())) {
                        i++;
                    } else {
