...
/* JADX INFO: loaded from: meteor-client-1.21.5-local.jar:meteordevelopment/meteorclient/discordipc/RichPresence.class */
public class RichPresence {
    ...
    /* JADX INFO: loaded from: meteor-client-1.21.5-local.jar:meteordevelopment/meteorclient/discordipc/RichPresence$Assets.class */
    ...
    /* JADX INFO: loaded from: meteor-client-1.21.5-local.jar:meteordevelopment/meteorclient/discordipc/RichPresence$Timestamps.class */
    ...
    public JsonObject toJson() {
        ...
        if (this.timestamps != null) {
            ...
            if (this.timestamps.start != null) {
                a2.addProperty("start", this.timestamps.start);
            }
            if (this.timestamps.end != null) {
                a2.addProperty("end", this.timestamps.end);
            }
            o.add("timestamps", a2);
        }
        return o;
