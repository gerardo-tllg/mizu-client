...
/* JADX INFO: loaded from: meteor-client-1.21.5-local.jar:meteordevelopment/meteorclient/commands/FirstSeen2b2t.class */
        ...
        builder.then(argument("player", StringArgumentType.word()).executes(ctx -> {
            MeteorExecutor.execute(() -> {
                ...
                if (seenJson.getAsJsonObject().has("firstSeen")) {
                    ...
                    if (player != null) {
                        player.method_7353(class_2561.method_30163("§8[§7MasterClient§8] §7" + "MasterClient" + playerString + "§7 was first seen on " + "MasterClient" + formattedTimestamp + "§7."), false);
                        return;
                    }
                    return;
                }
