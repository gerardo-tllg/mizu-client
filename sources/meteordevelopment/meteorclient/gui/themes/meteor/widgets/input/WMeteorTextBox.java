...
/* JADX INFO: loaded from: meteor-client-1.21.5-local.jar:meteordevelopment/meteorclient/gui/themes/meteor/widgets/input/WMeteorTextBox.class */
public class WMeteorTextBox extends WTextBox implements MeteorWidget {
    ...
    /* JADX INFO: loaded from: meteor-client-1.21.5-local.jar:meteordevelopment/meteorclient/gui/themes/meteor/widgets/input/WMeteorTextBox$CompletionItem.class */
    ...
    protected void onRender(GuiRenderer renderer, double mouseX, double mouseY, double delta) {
        ...
        if ((this.focused && this.cursorVisible) || this.animProgress > 0.0d) {
            ...
            renderer.quad(((this.x + pad) + getTextWidth(this.cursor)) - overflowWidth, this.y + pad, theme.scale(1.0d), theme.textHeight(), theme.textColor.get());
