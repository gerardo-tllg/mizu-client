...
/* JADX INFO: loaded from: meteor-client-1.21.5-local.jar:meteordevelopment/meteorclient/gui/themes/revive/widgets/pressable/WReviveCheckbox.class */
public class WReviveCheckbox extends WCheckbox implements ReviveWidget {
    private double animProgress;

    public WReviveCheckbox(boolean checked) {
        super(checked);
