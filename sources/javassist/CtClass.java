...
/* JADX INFO: loaded from: meteor-client-1.21.5-local.jar:javassist/CtClass.class */
public abstract class CtClass {
    ...
    public synchronized Collection<String> getRefClasses() {
        ...
        if (cf != null) {
            ClassMap cm = new ClassMap() { // from class: javassist.CtClass.1
    ...
    public void writeFile() throws CannotCompileException, NotFoundException, IOException {
        writeFile(".");
    }
    ...
    /* JADX INFO: loaded from: meteor-client-1.21.5-local.jar:javassist/CtClass$DelayedFileOutputStream.class */
