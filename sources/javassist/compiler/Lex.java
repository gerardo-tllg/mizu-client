...
/* JADX INFO: loaded from: meteor-client-1.21.5-local.jar:javassist/compiler/Lex.class */
public class Lex implements TokenId {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:13:0x003a, code lost:
        ...
        return javassist.compiler.TokenId.BadToken;
     */
    /*
        ...
        if (c == 48) {
            if (c22 == 88 || c22 == 120) {
                while (true) {
                    c2 = getc();
                    if (48 <= c2 && c2 <= 57) {
                        value2 = (value2 * 16) + ((long) (c2 - 48));
                    } else if (65 <= c2 && c2 <= 70) {
                        value2 = (value2 * 16) + ((long) ((c2 - 65) + 10));
                    } else {
                        if (97 > c2 || c2 > 102) {
                            break;
                        }
                        value2 = (value2 * 16) + ((long) ((c2 - 97) + 10));
                    }
                }
