...
/* JADX INFO: loaded from: meteor-client-1.21.5-local.jar:javassist/compiler/TypeChecker.class */
public class TypeChecker extends Visitor implements Opcode, TokenId {
    ...
    public static ASTree getConstantFieldValue(CtField f) {
        ...
        if ((value instanceof Double) || (value instanceof Float)) {
            int token = value instanceof Double ? TokenId.DoubleConstant : 404;
            return new DoubleConst(((Number) value).doubleValue(), token);
        }
        if (value instanceof Number) {
            int token2 = value instanceof Long ? 403 : TokenId.IntConstant;
