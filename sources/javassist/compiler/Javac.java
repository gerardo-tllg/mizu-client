...
/* JADX INFO: loaded from: meteor-client-1.21.5-local.jar:javassist/compiler/Javac.class */
public class Javac {
    JvstCodeGen gen;
    SymbolTable stable;
    ...
    /* JADX INFO: loaded from: meteor-client-1.21.5-local.jar:javassist/compiler/Javac$CtFieldWithInit.class */
    ...
    private CtField compileField(FieldDecl fd) throws CannotCompileException, CompileError {
    ...
    public void recordProceed(String target, final String method) throws CompileError {
        ...
        ProceedHandler h = new ProceedHandler() { // from class: javassist.compiler.Javac.1
    ...
    public void recordStaticProceed(final String targetClass, final String method) throws CompileError {
        ProceedHandler h = new ProceedHandler() { // from class: javassist.compiler.Javac.2
            @Override // javassist.compiler.ProceedHandler
            public void doit(JvstCodeGen gen, Bytecode b, ASTList args) throws CompileError {
    ...
    public void recordSpecialProceed(String target, final String classname, final String methodname, final String descriptor, final int methodIndex) throws CompileError {
        Parser p = new Parser(new Lex(target));
        final ASTree texpr = p.parseExpression(this.stable);
        ProceedHandler h = new ProceedHandler() { // from class: javassist.compiler.Javac.3
            @Override // javassist.compiler.ProceedHandler
            public void doit(JvstCodeGen gen, Bytecode b, ASTList args) throws CompileError {
