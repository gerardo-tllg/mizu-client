...
/* JADX INFO: loaded from: meteor-client-1.21.5-local.jar:javassist/bytecode/BootstrapMethodsAttribute.class */
public class BootstrapMethodsAttribute extends AttributeInfo {
    public static final String tag = "BootstrapMethods";

    /* JADX INFO: loaded from: meteor-client-1.21.5-local.jar:javassist/bytecode/BootstrapMethodsAttribute$BootstrapMethod.class */
