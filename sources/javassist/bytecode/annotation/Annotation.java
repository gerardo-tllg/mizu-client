...
/* JADX INFO: loaded from: meteor-client-1.21.5-local.jar:javassist/bytecode/annotation/Annotation.class */
public class Annotation {
    ConstPool pool;
    int typeIndex;
    Map<String, Pair> members;

    /* JADX INFO: loaded from: meteor-client-1.21.5-local.jar:javassist/bytecode/annotation/Annotation$Pair.class */
    static class Pair {
        int name;
        MemberValue value;
