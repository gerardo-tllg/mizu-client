...
/* JADX INFO: loaded from: meteor-client-1.21.5-local.jar:javassist/bytecode/LineNumberAttribute.class */
public class LineNumberAttribute extends AttributeInfo {
    public static final String tag = "LineNumberTable";

    /* JADX INFO: loaded from: meteor-client-1.21.5-local.jar:javassist/bytecode/LineNumberAttribute$Pc.class */
