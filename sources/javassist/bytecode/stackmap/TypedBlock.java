...
/* JADX INFO: loaded from: meteor-client-1.21.5-local.jar:javassist/bytecode/stackmap/TypedBlock.class */
public class TypedBlock extends BasicBlock {
    ...
    /* JADX INFO: loaded from: meteor-client-1.21.5-local.jar:javassist/bytecode/stackmap/TypedBlock$Maker.class */
    ...
    void initFirstBlock(int maxStack, int maxLocals, String className, String methodDesc, boolean isStatic, boolean isConstructor) throws BadBytecode {
        ...
        while (true) {
            try {
                n++;
                int iDescToTag = descToTag(methodDesc, i, n, locals);
                i = iDescToTag;
                if (iDescToTag > 0) {
