...
/* JADX INFO: loaded from: meteor-client-1.21.5-local.jar:javassist/bytecode/analysis/ControlFlow.class */
public class ControlFlow {
    ...
    public Node[] dominatorTree() {
        ...
        Access access = new Access(nodes) { // from class: javassist.bytecode.analysis.ControlFlow.2
    ...
    public Node[] postDominatorTree() {
        ...
        Access access = new Access(nodes) { // from class: javassist.bytecode.analysis.ControlFlow.3
            @Override // javassist.bytecode.analysis.ControlFlow.Access
            BasicBlock[] exits(Node n) {
                return n.block.entrances;
            }
    ...
    /* JADX INFO: loaded from: meteor-client-1.21.5-local.jar:javassist/bytecode/analysis/ControlFlow$Block.class */
    ...
    /* JADX INFO: loaded from: meteor-client-1.21.5-local.jar:javassist/bytecode/analysis/ControlFlow$Access.class */
    ...
    /* JADX INFO: loaded from: meteor-client-1.21.5-local.jar:javassist/bytecode/analysis/ControlFlow$Node.class */
    ...
    /* JADX INFO: loaded from: meteor-client-1.21.5-local.jar:javassist/bytecode/analysis/ControlFlow$Catcher.class */
