...
/* JADX INFO: loaded from: meteor-client-1.21.5-local.jar:javassist/bytecode/Descriptor.class */
public class Descriptor {
    ...
    public static String toClassName(String descriptor) {
        ...
        int arrayDim = 0;
        int i = 0;
        char cCharAt = descriptor.charAt(0);
        while (true) {
            c = cCharAt;
            if (c != '[') {
                break;
    ...
    /* JADX INFO: loaded from: meteor-client-1.21.5-local.jar:javassist/bytecode/Descriptor$PrettyPrinter.class */
    ...
    /* JADX INFO: loaded from: meteor-client-1.21.5-local.jar:javassist/bytecode/Descriptor$Iterator.class */
