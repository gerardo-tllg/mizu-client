...
/* JADX INFO: loaded from: meteor-client-1.21.5-local.jar:javassist/scopedpool/ScopedClassPoolRepositoryImpl.class */
public class ScopedClassPoolRepositoryImpl implements ScopedClassPoolRepository {
    ...
    public void clearUnregisteredClassLoaders() {
        ...
        synchronized (this.registeredCLs) {
            ...
            if (toUnregister != null) {
                Iterator<ClassLoader> it = toUnregister.iterator();
                while (it.hasNext()) {
                    unregisterClassLoader(it.next());
                }
            }
        }
    }
