...
/* JADX INFO: loaded from: meteor-client-1.21.5-local.jar:javassist/util/proxy/DefineClassHelper.class */
public class DefineClassHelper {
    private static final Helper privileged;

    /* JADX INFO: loaded from: meteor-client-1.21.5-local.jar:javassist/util/proxy/DefineClassHelper$Helper.class */
    private static abstract class Helper {
        abstract Class<?> defineClass(String str, byte[] bArr, int i, int i2, Class<?> cls, ClassLoader classLoader, ProtectionDomain protectionDomain) throws CannotCompileException, ClassFormatError;

        private Helper() {
        }
    }

    /* JADX INFO: loaded from: meteor-client-1.21.5-local.jar:javassist/util/proxy/DefineClassHelper$Java11.class */
    private static class Java11 extends JavaOther {
        ...
        Class<?> defineClass(String name, byte[] bcode, int off, int len, Class<?> neighbor, ClassLoader loader, ProtectionDomain protectionDomain) throws CannotCompileException, ClassFormatError {
            if (neighbor != null) {
    ...
    /* JADX INFO: loaded from: meteor-client-1.21.5-local.jar:javassist/util/proxy/DefineClassHelper$Java9.class */
    private static class Java9 extends Helper {
        ...
        /* JADX INFO: loaded from: meteor-client-1.21.5-local.jar:javassist/util/proxy/DefineClassHelper$Java9$ReferencedUnsafe.class */
    ...
    /* JADX INFO: loaded from: meteor-client-1.21.5-local.jar:javassist/util/proxy/DefineClassHelper$Java7.class */
    ...
    /* JADX INFO: loaded from: meteor-client-1.21.5-local.jar:javassist/util/proxy/DefineClassHelper$JavaOther.class */
    private static class JavaOther extends Helper {
        ...
        @Override // javassist.util.proxy.DefineClassHelper.Helper
        Class<?> defineClass(String name, byte[] b, int off, int len, Class<?> neighbor, ClassLoader loader, ProtectionDomain protectionDomain) throws CannotCompileException, ClassFormatError {
