...
/* JADX INFO: loaded from: meteor-client-1.21.5-local.jar:javassist/util/proxy/ProxyFactory.class */
public class ProxyFactory {
    ...
    /* JADX INFO: loaded from: meteor-client-1.21.5-local.jar:javassist/util/proxy/ProxyFactory$ClassLoaderProvider.class */
    public interface ClassLoaderProvider {
        ClassLoader get(ProxyFactory proxyFactory);
    }

    /* JADX INFO: loaded from: meteor-client-1.21.5-local.jar:javassist/util/proxy/ProxyFactory$UniqueName.class */
    ...
    /* JADX INFO: loaded from: meteor-client-1.21.5-local.jar:javassist/util/proxy/ProxyFactory$ProxyDetails.class */
    ...
    public Object create(Class<?>[] paramTypes, Object[] args, MethodHandler mh) throws IllegalAccessException, NoSuchMethodException, InstantiationException, IllegalArgumentException, InvocationTargetException {
        Object obj = create(paramTypes, args);
        ((Proxy) obj).setHandler(mh);
        return obj;
    }

    public Object create(Class<?>[] paramTypes, Object[] args) throws IllegalAccessException, NoSuchMethodException, InstantiationException, IllegalArgumentException, InvocationTargetException {
        Class<?> c = createClass();
    ...
    private static void addClassInitializer(ClassFile cf, ConstPool cp, String classname, int size, List<Find2MethodsArgs> forwarders) throws CannotCompileException {
        ...
        setThrows(minfo, cp, (Class<?>[]) new Class[]{ClassNotFoundException.class});
    ...
    private static MethodInfo makeConstructor(String thisClassName, Constructor<?> cons, ConstPool cp, Class<?> superClass, boolean doHandlerInit) {
        String desc = RuntimeSupport.makeDescriptor(cons.getParameterTypes(), (Class<?>) Void.TYPE);
    ...
    /* JADX INFO: loaded from: meteor-client-1.21.5-local.jar:javassist/util/proxy/ProxyFactory$Find2MethodsArgs.class */
