...
/* JADX INFO: loaded from: meteor-client-1.21.5-local.jar:javassist/util/proxy/RuntimeSupport.class */
public class RuntimeSupport {
    public static MethodHandler default_interceptor = new DefaultMethodHandler();

    /* JADX INFO: loaded from: meteor-client-1.21.5-local.jar:javassist/util/proxy/RuntimeSupport$DefaultMethodHandler.class */
