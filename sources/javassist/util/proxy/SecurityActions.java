...
/* JADX INFO: loaded from: meteor-client-1.21.5-local.jar:javassist/util/proxy/SecurityActions.class */
class SecurityActions extends SecurityManager {
    ...
    static TheUnsafe getSunMiscUnsafeAnonymously() throws ClassNotFoundException {
        try {
            return (TheUnsafe) AccessController.doPrivileged(new PrivilegedExceptionAction<TheUnsafe>() { // from class: javassist.util.proxy.SecurityActions.8
                /* JADX WARN: Can't rename method to resolve collision */
                @Override // java.security.PrivilegedExceptionAction
                public TheUnsafe run() throws IllegalAccessException, NoSuchFieldException, ClassNotFoundException, SecurityException, IllegalArgumentException {
    ...
    /* JADX INFO: loaded from: meteor-client-1.21.5-local.jar:javassist/util/proxy/SecurityActions$TheUnsafe.class */
    class TheUnsafe {
        final Class<?> unsafe;
