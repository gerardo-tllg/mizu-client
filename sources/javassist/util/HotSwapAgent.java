...
/* JADX INFO: loaded from: meteor-client-1.21.5-local.jar:javassist/util/HotSwapAgent.class */
public class HotSwapAgent {
    ...
    public static void redefine(Class<?> oldClass, CtClass newClass) throws CannotCompileException, NotFoundException, IOException {
        Class<?>[] old = {oldClass};
        CtClass[] newClasses = {newClass};
        redefine(old, newClasses);
    }

    public static void redefine(Class<?>[] oldClasses, CtClass[] newClasses) throws CannotCompileException, NotFoundException, IOException {
        startAgent();
    ...
    public static File createAgentJarFile(String fileName) throws CannotCompileException, NotFoundException, IOException {
        return createJarFile(new File(fileName));
    }

    private static File createJarFile() throws CannotCompileException, NotFoundException, IOException {
        File jar = File.createTempFile("agent", ".jar");
        jar.deleteOnExit();
        return createJarFile(jar);
    }

    private static File createJarFile(File jar) throws CannotCompileException, NotFoundException, IOException {
