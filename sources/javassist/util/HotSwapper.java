...
/* JADX INFO: loaded from: meteor-client-1.21.5-local.jar:javassist/util/HotSwapper.class */
public class HotSwapper {
    ...
    public HotSwapper(int port) throws IllegalConnectorArgumentsException, IOException {
        this(Integer.toString(port));
    }

    public HotSwapper(String port) throws IllegalConnectorArgumentsException, IOException {
        this.jvm = null;
        this.request = null;
            ...
            */
            public void run() {
                /*
                    ...
                    r4 = r0
                    r0 = r3
                    javassist.util.HotSwapper r0 = javassist.util.HotSwapper.this     // Catch: java.lang.Throwable -> L38
