...
/* JADX INFO: loaded from: meteor-client-1.21.5-local.jar:javassist/expr/NewArray.class */
public class NewArray extends Expr {
    ...
    private void replace2(String statement) throws CannotCompileException, BadBytecode, NotFoundException, CompileError {
        int index;
        String desc;
        int codeLength;
    ...
    /* JADX INFO: loaded from: meteor-client-1.21.5-local.jar:javassist/expr/NewArray$ProceedForArray.class */
