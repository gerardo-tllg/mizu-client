...
/* JADX INFO: loaded from: meteor-client-1.21.5-local.jar:javassist/Loader.class */
public class Loader extends ClassLoader {
    ...
    /* JADX INFO: loaded from: meteor-client-1.21.5-local.jar:javassist/Loader$Simple.class */
    public static class Simple extends ClassLoader {
        ...
        public Class<?> invokeDefineClass(CtClass cc) throws CannotCompileException, IOException {
    ...
    public void addTranslator(ClassPool cp, Translator t) throws CannotCompileException, NotFoundException {
        this.source = cp;
        this.translator = t;
        t.start(cp);
    }
