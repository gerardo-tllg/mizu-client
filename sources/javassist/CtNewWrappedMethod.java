...
/* JADX INFO: loaded from: meteor-client-1.21.5-local.jar:javassist/CtNewWrappedMethod.class */
class CtNewWrappedMethod {
    ...
    private static String addBodyMethod(CtClassType clazz, ClassFile classfile, CtMethod src) throws CannotCompileException, BadBytecode {
