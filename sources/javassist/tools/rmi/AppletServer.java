...
/* JADX INFO: loaded from: meteor-client-1.21.5-local.jar:javassist/tools/rmi/AppletServer.class */
public class AppletServer extends Webserver {
    ...
    public AppletServer(String port) throws CannotCompileException, NotFoundException, IOException {
        this(Integer.parseInt(port));
    }

    public AppletServer(int port) throws CannotCompileException, NotFoundException, IOException {
        this(ClassPool.getDefault(), new StubGenerator(), port);
    }

    public AppletServer(int port, ClassPool src) throws CannotCompileException, NotFoundException, IOException {
        this(new ClassPool(src), new StubGenerator(), port);
    }

    private AppletServer(ClassPool loader, StubGenerator gen, int port) throws CannotCompileException, NotFoundException, IOException {
        super(port);
